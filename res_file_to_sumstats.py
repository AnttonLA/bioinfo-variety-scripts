...
"""This script takes a DeCODE .res file (table with ID, beta and chi-square columns) and filters the table by pval threshold.
"""
...
for i, gwas_file in enumerate(os.listdir(files_filepath)):
    if gwas_file.endswith('.res'):
        ...
        for chunk in f:
            ...
            list_of_downsampled_chunks.append(chunk[chunk.chi2 > 23].copy())  # Tale
